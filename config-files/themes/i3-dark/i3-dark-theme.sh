...
sed -i 's/focused_workspace\  .*\ .*\ .*/focused_workspace\  #14161B\ #14161B\ #C0C0C0/g' $HOME/.i3/config
...
sed -i 's/client.focused\          .*\ .*\ .*\ .*/client.focused\          #22252C\ #C0C0C0\ #2B2B2B\ #FDF6E3/g' $HOME/.i3/config
...
sed -i 's/DMENU_SB=.*/DMENU_SB="#22252C"/g' $HOME/.dmenurc &&
